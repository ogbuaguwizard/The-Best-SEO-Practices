...
- Submit to Google Search Console: This is a deployment phase action, which we will cover in [Part 2](https://github.com/ogbuaguwizard/The-Best-SEO-Practices/blob/main/part2.md).
